...
export async function registerParent(parentData: ParentData): Promise<RegisterParentResult> {
    ...
    if (phoneMatch) {
        ...
        return { parentId: phoneMatch.parent_id, isExisting: true, wasCreated: false, existingName, duplicateField: 'phone' };
    }
    ...
    if (trimmedEmail) {
        ...
        if (emailMatch) {
            ...
            return { parentId: emailMatch.parent_id, isExisting: true, wasCreated: false, existingName, duplicateField: 'email' };
        }
    }
